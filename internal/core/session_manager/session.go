...
type Session struct {
	...
	backwardsInvocation mlchain_invocation.BackwardsInvocation `json:"-"`
...
type NewSessionPayload struct {
	...
	Action                 access_types.PluginAccessAction        `json:"action"`
	Declaration            *plugin_entities.PluginDeclaration     `json:"declaration"`
	BackwardsInvocation    mlchain_invocation.BackwardsInvocation `json:"backwards_invocation"`
...
func (s *Session) BindBackwardsInvocation(backwardsInvocation mlchain_invocation.BackwardsInvocation) {
	s.backwardsInvocation = backwardsInvocation
}

func (s *Session) BackwardsInvocation() mlchain_invocation.BackwardsInvocation {
