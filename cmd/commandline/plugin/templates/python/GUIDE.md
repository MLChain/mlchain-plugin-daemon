...
- [OpenAI](https://github.com/mlchain/mlchain-plugin-sdks/tree/main/python/examples/openai): best practice for model provider
- [Google Search](https://github.com/mlchain/mlchain-plugin-sdks/tree/main/python/examples/google): a simple example for tool provider
- [Neko](https://github.com/mlchain/mlchain-plugin-sdks/tree/main/python/examples/neko): a funny example for endpoint group
